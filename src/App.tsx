import { Menu, X, Award, Droplet, Shield, Minimize2, Sun, Flame, Home, Sparkles, Building2, ShieldCheck, PaintBucket, Layers, Check, MapPin, Phone, Mail, Clock } from "lucide-react";
...
function App() {
  ...
  const products = [
    ...
    {
      icon: ShieldCheck,
      title: "Резиновая краска",
      sizes: ["9л (14кг)", "18л (20кг)"],
      description1:
        "Современное водно-дисперсионное лакокрасочное покрытие на основе акрилового латекса, образующее после высыхания эластичную, прочную и влагонепроницаемую плёнку.",
      description2:
        "Используется для наружных и внутренних работ: фасады зданий; кровля, шифер, металл, бетонные поверхности; деревянные конструкции, заборы, цоколи, фундаменты; декоративные и гидроизоляционные покрытия.",
      features: [
        "Высокая эластичность и износостойкость",
        "Водонепроницаемость и устойчивость к растрескиванию",
        "Отличная адгезия к бетону, металлу, дереву, кирпичу и шиферу",
        "Устойчивость к ультрафиолетовому излучению и атмосферным осадкам",
        "Быстрое высыхание (1–2 часа при +20 °C)",
        "Без резкого запаха, экологически безопасна (на водной основе)",
      ],
      application:
        "Краска обладает повышенной адгезией к различным поверхностям и устойчива к атмосферным воздействиям, ультрафиолету и механическим нагрузкам. После высыхания покрытие напоминает резину — не растрескивается при перепадах температур и сохраняет цвет на протяжении всего срока эксплуатации. Перед нанесением поверхность очистить от пыли, грязи, ржавчины и старых отслаивающихся покрытий. При необходимости загрунтовать. Краску тщательно перемешать, при необходимости разбавить водой (до 10 %). Наносить кистью, валиком или краскопультом в 1–2 слоя.",
      volume: "20кг",
      priceWholesale: "... тг/кг",
      priceRetail: "... тг/кг",
    },
    {
      icon: PaintBucket,
      ...
      sizes: ["9л (14кг)", "18л (20кг)"],
      description1:
        "Алкидная эмаль с повышенной износостойкостью и влагостойкостью. Образует прочное глянцевое покрытие, устойчивое к истиранию и атмосферным воздействиям.",
      description2:
        "Предназначена для окраски металлических, деревянных, бетонных и оштукатуренных поверхностей внутри и снаружи помещений. Подходит для радиаторов, дверей, оконных рам, мебели, перил и других изделий.",
      features: [
        "Быстрое высыхание (до 6 часов при +20 °C)",
        "Стойкость к ультрафиолету, влаге и моющим средствам",
        "Образует гладкое, блестящее и плотное покрытие",
        "Хорошая укрывистость и адгезия",
        "Применяется для внутренних и наружных работ",
      ],
      application:
        "Эмалевая краска предназначена для окраски металлических и деревянных поверхностей, подвергающихся атмосферным и механическим нагрузкам. Обеспечивает долговечное декоративное покрытие с повышенной стойкостью к влаге и солнечному свету. Перед нанесением поверхность очистить и обезжирить. Наносить кистью, валиком или распылителем в 1–2 слоя.",
      volume: "10кг",
      priceWholesale: "... тг/кг",
      priceRetail: "... тг/кг",
    },
    {
      icon: Layers,
      title: "Грунтовочная краска",
      sizes: ["9л (14кг)", "18л (20кг)"],
      description1:
        "Глубокопроникающая акриловая грунтовка на водной основе, предназначенная для укрепления и подготовки поверхности перед окраской.",
      description2:
        "Применяется для бетонных, кирпичных, оштукатуренных, гипсокартонных и других минеральных поверхностей. Снижает расход краски, улучшает сцепление и выравнивает впитываемость.",
      features: [
        "Укрепляет слабые и пористые основания",
        "Повышает адгезию лакокрасочных покрытий",
        "Снижает расход финишной краски до 20%",
        "Быстро сохнет (1–2 часа при +20 °C)",
        "Без запаха, экологически безопасна",
      ],
      application:
        "Грунтовочная краска используется перед нанесением интерьерных, фасадных и других покрытий для улучшения адгезии и долговечности финишного слоя. Подходит для любых минеральных оснований. Наносится кистью, валиком или распылителем на чистую сухую поверхность.",
      volume: "20кг",
      priceWholesale: "... тг/кг",
      priceRetail: "... тг/кг",
    },
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">alistroi86@gmail.com</p>
                    </div>
                  </div>
